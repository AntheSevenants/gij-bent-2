...
@fig-region-violin shows the dispersion of variation by Flemish dialect region. Here, we do not see a "reverse" pattern, in contrast to @fig-gender-violin. The Brabant dialect shows individual variation which is comparable both for innovative and conservative variants, whereas the other dialects gravitate towards more conservative corrections. We see that there are innovators in all three non-Brabant regions, but they are generally few. Maybe these are near border-regions? TODO
...
Just from this general overview, we see that there are patterns among the variation. Though speakers are of course free to use whatever forms they want, how they deviate from expectations is not random.
