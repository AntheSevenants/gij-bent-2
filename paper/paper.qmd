...
For our analysis, we used ElasticToolsR [@sevenants_elastic_2024], a package for the R language [@r_language_2021] which simplifies running elastic net regression models. This package also automatically determines the best split between ridge and lasso regression.
