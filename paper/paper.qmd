...
It is essential to recognize that the widespread changes observed across entire populations ultimately stem from changes that begin within individuals. While linguistic changes may eventually become collective phenomena, their origins lie in the minds and speech of individual speakers. This is why both from a usage-based and a cognitive-linguistic perspective the individual should be the primary unit of linguistic analysis where possible. Recent studies into individual variation in language use reveal that linguistic behavior is not uniformly progressive or conservative, either within individuals or among groups [Nevalainen, Raumolin-Brunberg, and Mannila 2011 TODO]. While later-born authors often show more progressive tendencies, there is notable individual variation even within generational cohorts [Petré and Van de Velde 2018 TODO]. There is also variation in the language-internal factors influencing language change. While most language-internal factors are broadly shared, less influential factors reveal personal differences in usage [Fonteyn and Nini 2020 TODO]. Moreover, some individuals are more adaptable to linguistic change over their lifetimes, while others remain stable or even deviate in the opposite direction [Fonteyn and Petré 2022 TODO]. Personality traits also play a role, affecting how individuals adopt or evaluate new linguistic features [Guy 2013; Zenner, Kristiansen, and Geeraerts 2016; Van den Stock et al. 2024 TODO].
...
Linguistically, the effects of networks have been studied before. Milroy and Milroy [1985 TODO], who base themselves on Granovetter [1973 TODO] and Rogers and Shoemaker [1971 TODO], demonstrated that in a network both weak and strong ties are essential for the propagation of linguistic change. Strong ties (e.g. close friends and family) maintain and reinforce linguistic norms within tight-knit groups, resisting linguistic innovation. In contrast, weak ties (e.g. acquaintances) form bridges between groups, facilitate the spread of linguistic innovations. Weak ties are especially crucial for exposing individuals to linguistic features or patterns that are not present within their immediate, tightly connected group, enabling the flow of new linguistic forms across disparate groups, broadening the reach of linguistic innovations. Once exposed to these new forms, individuals connected through weak ties may adopt them and, through their strong ties, introduce them to their close-knit circles. 
